...
#define MODULE NS_ERROR_MODULE_DOM
  ...
  /* When manipulating the presistent bytecode cache with the JS API, some
   * transcoding errors, such as a different bytecode format can cause failures
   * of the decoding process.
   */
  ERROR(NS_ERROR_DOM_JS_DECODING_ERROR,            FAILURE(1029)),
