...
class FloatRegisters {
  public:
    ...
    static const uint32_t Total = 16 * NUM_TYPES;
    static const uint32_t TotalPhys = 16;
    ...
    static const SetType NonAllocatableMask =
        spread_ * (1 << X86Encoding::xmm15);    // This is ScratchDoubleReg.
...
struct FloatRegister {
    ...
    static uint32_t SetSize(SetType x) {
        static_assert(sizeof(SetType) == 8, "SetType must be 32 bits");
